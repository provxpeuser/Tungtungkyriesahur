...
var RefluxAPI = class {
  ...
  constructor() {
    try {
      this.pluginStorage = import_localforage.default.createInstance({
        name: "Reflux",
        storeName: "plugins"
      });
      this.statusStorage = import_localforage.default.createInstance({
        name: "Reflux",
        storeName: "status"
      });
    } catch (e) {
  ...
  ensureStorages() {
    if (!this.pluginStorage) {
      this.pluginStorage = import_localforage.default.createInstance({ name: "Reflux", storeName: "plugins" });
    }
    if (!this.statusStorage) {
      this.statusStorage = import_localforage.default.createInstance({ name: "Reflux", storeName: "status" });
    }
  }
